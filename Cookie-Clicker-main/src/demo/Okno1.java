    ...
    public Okno1() {
        ...
        try {
            ...
            while(br.ready()){
                ...
                spers = Math.round(Double.parseDouble(br.readLine())*10)/10.0;
        ...
        sps.setText("Score per Second: "+Math.round((spers)*10)/10.0);
